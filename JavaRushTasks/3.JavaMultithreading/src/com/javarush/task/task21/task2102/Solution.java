...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
       /*boolean modPubl = Modifier.isPublic(allModifiers);
        boolean modStatic = Modifier.isStatic(allModifiers);
        if ((modPubl) && (Modifier.PUBLIC==specificModifier))
                return true;
        else if ((modStatic) && (Modifier.STATIC==specificModifier))
            return true;
        else
            return false;*/
